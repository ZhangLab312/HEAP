...
class options():
    def __init__(self):
        ...
        parser.add_argument('--score_lr', default=.001, type = float, help = '')
        ...
        parser.add_argument('--momentum', type = float, default=.09)
        parser.add_argument('--wd', type = float, default=0)
        parser.add_argument('--gpu', type = int, default=0)
        parser.add_argument('--save-frequency', type = int, default=10)
        parser.add_argument('--result_path', type = str, default='./ex_result_binary_new/')
